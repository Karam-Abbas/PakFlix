...
const FooterIn = () => {
  return (
    <footer className="bg-[#141414] text-gray-500 py-8 px-4 md:px-12">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
          <div className="flex flex-col gap-3">
            <Link href="#" className="hover:text-white">Audio Description</Link>
            <Link href="#" className="hover:text-white">Investor Relations</Link>
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link href="#" className="hover:text-white">Corporate Information</Link>
          </div>
          <div className="flex flex-col gap-3">
            <Link href="#" className="hover:text-white">Media Center</Link>
        ...
        {/* Service Code Button */}
        <button className="mt-8 border border-gray-500 px-4 py-2 text-sm hover:text-white">
          Service Code
        </button>

        {/* Copyright */}
        <div className="mt-4 text-xs">
          © 1997-2025 PakFlix, Inc.
        </div>
      </div>
    </footer>
  )
